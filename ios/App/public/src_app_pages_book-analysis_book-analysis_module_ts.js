...
let BookAnalysisPage = class BookAnalysisPage {
    ...
    initForm() {
        this.form = this.fb.group({
            ...
            dob: ["", [_angular_forms__WEBPACK_IMPORTED_MODULE_11__.Validators.required]],
    ...
    deliveryChange(event) {
        ...
        if (!this.deliveryAddress) {
            this.form
                ...
                .setValidators([
                _angular_forms__WEBPACK_IMPORTED_MODULE_11__.Validators.required,
                _angular_forms__WEBPACK_IMPORTED_MODULE_11__.Validators.pattern(src_app_utility_pattern__WEBPACK_IMPORTED_MODULE_5__.pattern.alphabate),
    ...
    changeDate(val) {
        ...
        console.log(age);
        this.form.get("dob").setValue((0,date_fns__WEBPACK_IMPORTED_MODULE_12__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_13__["default"])(val), "MMM dd yyyy"));
        this.birthday = false;
    }
    buyCart(formdata) {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_10__.__awaiter)(this, void 0, void 0, function* () {
    ...
    inAppBrowser(paymentUrl) {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_10__.__awaiter)(this, void 0, void 0, function* () {
            if (this.platform.is('android')) {
                ...
                _capacitor_browser__WEBPACK_IMPORTED_MODULE_7__.Browser.open({ url: paymentUrl });
                _capacitor_browser__WEBPACK_IMPORTED_MODULE_7__.Browser.addListener('browserPageLoaded', () => { }).then((info) => {
                    console.log(info);
                });
                _capacitor_browser__WEBPACK_IMPORTED_MODULE_7__.Browser.addListener('browserFinished', () => { }).then((info) => {
                    console.log(info);
                    this.paymentInti = false;
                });
            }
    ...
    closeBrowser() {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_10__.__awaiter)(this, void 0, void 0, function* () {
            if (this.platform.is('android')) {
                ...
                _capacitor_browser__WEBPACK_IMPORTED_MODULE_7__.Browser.close();
            }
        });
    }
    onManualClose() {
    ...
    validatePayment(userBillingData) {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_10__.__awaiter)(this, void 0, void 0, function* () {
...
module.exports = ".register-img-layer {\n  display: block;\n  margin-top: 30px;\n}\n.register-img-layer img {\n  width: 180px;\n  margin: auto;\n  display: block;\n}\n.register-img {\n  display: block;\n  background: url('register.jpeg');\n  width: 285px;\n  height: 145px;\n  border-radius: 15px;\n  margin: 30px auto 20px auto;\n  background-position: center;\n}\n.register-header {\n  padding-top: 15px !important;\n}\n.register-header h1 {\n  margin: 0px;\n  font-size: 24px;\n  color: #666666;\n  font-style: normal;\n  font-weight: normal;\n  text-align: left;\n  margin-left: 20px;\n}\n.filled-data {\n  margin-left: 20px;\n  padding-top: 20px !important;\n}\n.filled-data h3 {\n  margin: 5px;\n}\n.filled-data p {\n  margin: 5px;\n}\n.dont-know {\n  color: #6d6d6d;\n  font-size: 15px;\n  font-weight: 700;\n  text-decoration: none;\n  text-align: center;\n  width: 100%;\n  display: block;\n  margin-top: 20px;\n  margin-bottom: 15px;\n}\n.dont-know span {\n  color: #a9d5c1;\n  font-weight: 400;\n}\nform {\n  padding: 5px;\n  padding-top: 0px;\n}\nform .form-group {\n  position: relative;\n  --inner-padding-end: 5px !important;\n  margin-top: 10px;\n}\nform ion-input,\nform ion-select,\nform ionic-selectable {\n  font-style: normal;\n  font-weight: normal;\n  font-size: 12px;\n  border: 1px solid #d6d6d6 !important;\n  height: 45px;\n  width: 100%;\n  max-width: 100%;\n  border-radius: 5px !important;\n  padding: 0px 11px !important;\n  --padding-bottom: 0px;\n  --padding-top: 0px;\n  --padding-start: 0px;\n  --padding-end: 0px;\n  --inner-padding-end: 0 !important;\n}\nform ion-label.label-floating {\n  position: relative;\n  top: 3px;\n  left: 10px;\n  font-size: 12px !important;\n  color: gray !important;\n}\nform .password-input {\n  position: relative;\n}\nform .password-input ion-input {\n  --padding-bottom: 0px;\n  --padding-top: 0px;\n  --padding-start: 0px;\n  --padding-end: 40px;\n}\nform .password-input ion-icon {\n  position: absolute;\n  bottom: 10px;\n  right: 20px;\n  font-size: 25px;\n  z-index: 9999;\n}\nform .forgot-password {\n  color: #6d6d6d;\n  font-size: 12px;\n  font-weight: 400;\n  text-decoration: none;\n}\nform .dont-know {\n  color: #6d6d6d;\n  font-size: 12px;\n  font-weight: 400;\n  text-decoration: none;\n  text-align: center;\n  width: 100%;\n  display: block;\n  margin-top: 20px;\n}\nform .dont-know span {\n  color: #ff662a;\n}\nform .btns {\n  height: 40px;\n  font-size: 12px;\n  font-weight: 600;\n  --border-radius: 4px;\n  margin: 20px;\n}\nform ion-item.form-group.country-group {\n  top: 2px;\n  position: relative;\n  width: 70px;\n  border: 1px solid #d4d4d4;\n  height: 40px;\n  border-radius: 4px;\n  color: #727272;\n  font-size: 12px;\n}\nform .activation-code {\n  top: 32px;\n  position: absolute;\n  border-radius: 4px;\n  color: #6d6d6d;\n  font-size: 12px;\n}\nform .activation-code p {\n  margin: 0px;\n}\nform .activation-code p.find-label {\n  width: 100%;\n  color: #a9d5c1;\n}\nform .phone-code-div {\n  padding: 0px !important;\n  display: flex;\n  margin-right: 10px;\n  border: 1px solid #ccc;\n  border-radius: 5px;\n}\nform .phone-code-div span {\n  width: 20px;\n}\nform .phone-ion {\n  width: 82px;\n  border: 0px !important;\n}\nform .phone-ion .ionic-selectable-icon {\n  display: none !important;\n}\nform div {\n  padding: 1px 10px;\n}\nform .check-div {\n  display: flex;\n  padding-right: 20px;\n}\nform .check-div ion-checkbox {\n  margin-left: 2px;\n  margin-top: 0px;\n}\n.my-search-class {\n  --height: 500px;\n  --width: 80%;\n}\nion-datetime {\n  position: absolute !important;\n  bottom: 20% !important;\n  max-width: none !important;\n  left: 10%;\n  right: 10%;\n}\n.birthday {\n  --box-shadow:none;\n  margin: auto;\n  --background: transparent !important;\n  align-items: unset;\n}\n.hidden {\n  display: none;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
