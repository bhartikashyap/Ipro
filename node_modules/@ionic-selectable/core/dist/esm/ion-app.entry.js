import { r as registerInstance, h, H as Host, a as getElement } from './index-463d92b6.js';
import { g as getIonMode, c as config, a as isPlatform } from './ionic-global-45a734ec.js';
  ...
  componentDidLoad() {
    {
      rIC(async () => {
        ...
        if (!config.getBoolean('_testing')) {
          import('./tap-click-10b77474.js').then(module => module.startTapClick(config));
        }
        if (config.getBoolean('statusTap', isHybrid)) {
          import('./status-tap-6037b5ee.js').then(module => module.startStatusTap());
        }
        if (config.getBoolean('inputShims', needInputShims())) {
          import('./input-shims-9a5cf412.js').then(module => module.startInputShims(config));
        }
