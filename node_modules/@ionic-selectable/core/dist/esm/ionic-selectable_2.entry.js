import { r as registerInstance, c as createEvent, h, H as Host, a as getElement } from './index-463d92b6.js';
import { m as modalController } from './overlays-da3616bf.js';
import { i as IonicSelectableSelectedEvent, g as IonicSelectableChangedEvent, k as IonicSelectableOpenedEvent, j as IonicSelectableClosedEvent, f as IonicSelectableClearedEvent, e as IonicSelectableItemAddingEvent, b as IonicSelectableSearchingEvent, a as IonicSelectableInfiniteScrolledEvent, d as IonicSelectableSearchSuccessedEvent, c as IonicSelectableSearchFailedEvent } from './ionic-selectable.interfaces.component-dca593f8.js';
import './ionic-global-45a734ec.js';
import './hardware-back-button-508e48cf.js';
import './helpers-2a92b02c.js';
...
const IonicSelectableComponent = class {
  constructor(hostRef) {
    ...
    this.infiniteScrolled = createEvent(this, "infiniteScrolled", 7);
    this.searching = createEvent(this, "searching", 7);
    this.searchFailed = createEvent(this, "searchFailed", 7);
    this.searchSuccessed = createEvent(this, "searchSuccessed", 7);
    this.itemAdding = createEvent(this, "itemAdding", 7);
    this.cleared = createEvent(this, "cleared", 7);
    this.changed = createEvent(this, "changed", 7);
    this.itemsChanged = createEvent(this, "itemsChanged", 7);
  ...
  render() {
    ...
    return (h(Host, { id: this.id, onClick: this.onClick, role: "combobox", "aria-haspopup": "dialog", "aria-disabled": isDisabled ? 'true' : null, "aria-expanded": `${isOpened}`, "aria-labelledby": labelId, class: {
      ...
      } }, valueRender, this.hasTemplateRender && this.hasTemplateRender('icon') ? (h("div", { class: "ionic-selectable-icon-template", ref: element => {
        this.templateRender(element, {
          type: 'icon',
        });
      } })) : (h("div", { class: "ionic-selectable-icon", role: "presentation", part: "icon" }, h("div", { class: "ionic-selectable-icon-inner", part: "icon-inner" }))), h("button", { type: "button", onFocus: this.onFocus, onBlur: this.onBlur, disabled: isDisabled, ref: buttonElement => (this.buttonElement = buttonElement) })));
  }
...
const IonicSelectableModalComponent = class {
  ...
  renderItem(item) {
    return (h("ion-item", { button: true, onClick: () => this.selectableComponent.selectItem(item), disabled: this.selectableComponent.isItemDisabled(item) }, this.selectableComponent.hasTemplateRender && this.selectableComponent.hasTemplateRender('item') ? (h("span", { ref: element => {
      ...
      } })) : (h("ion-label", null, this.selectableComponent.getItemText(item))), this.selectableComponent.hasTemplateRender && this.selectableComponent.hasTemplateRender('itemEnd') && (h("div", { slot: "end", ref: element => {
        this.selectableComponent.templateRender(element, {
          type: 'itemEnd',
          value: item,
          isItemSelected: this.selectableComponent.isItemSelected(item),
  ...
  renderHeader(header) {
    return (h("ion-item-divider", { color: this.selectableComponent.groupColor }, h("ion-label", null, header)));
  }
  render() {
    return (h(Host, { class: {
        'ionic-selectable-modal-is-add-item-template-visible ': this.selectableComponent.isAddItemTemplateVisible,
      } }, h("ion-header", null, this.selectableComponent.hasTemplateRender && this.selectableComponent.hasTemplateRender('header') ? (h("div", { ref: element => {
        this.selectableComponent.templateRender(element, {
          type: 'header',
        });
      } })) : (h("ion-toolbar", { color: this.selectableComponent.headerColor }, h("ion-title", null, this.selectableComponent.hasTemplateRender && this.selectableComponent.hasTemplateRender('title') ? (h("span", { ref: element => {
        this.selectableComponent.templateRender(element, {
          type: 'title',
        });
      } })) : (h("span", null, this.selectableComponent.titleText))), h("ion-buttons", { slot: this.selectableComponent.closeButtonSlot }, h("ion-button", { onClick: () => this.selectableComponent.closeModal() }, this.selectableComponent.hasTemplateRender &&
      this.selectableComponent.hasTemplateRender('closeButton') ? (h("span", { ref: element => {
        this.selectableComponent.templateRender(element, {
          type: 'closeButton',
        });
      } })) : (h("span", null, this.selectableComponent.closeButtonText)))))), this.selectableComponent.canSearch ||
      (this.selectableComponent.hasTemplateRender && this.selectableComponent.hasTemplateRender('message') && (h("ion-toolbar", null, h("ion-searchbar", { value: this.selectableComponent.searchText, placeholder: this.selectableComponent.searchPlaceholder, debounce: this.selectableComponent.searchDebounce, cancelButtonIcon: this.selectableComponent.searchCancelButtonIcon, cancelButtonText: this.selectableComponent.searchCancelButtonText, clearIcon: this.selectableComponent.searchClearIcon, inputmode: this.selectableComponent.searchInputmode, searchIcon: this.selectableComponent.searchIcon, showCancelButton: this.selectableComponent.searchShowCancelButton, onIonChange: (event) => this.selectableComponent.onSearchbarValueChanged(event) }), this.selectableComponent.hasTemplateRender && this.selectableComponent.hasTemplateRender('message') && (h("div", { class: "ionic-selectable-message", ref: element => {
        ...
        } })))))), h("ion-content", null, this.selectableComponent.isSearching && (h("div", { class: "ionic-selectable-spinner" }, h("div", { class: "ionic-selectable-spinner-background" }), h("ion-spinner", null))), !this.selectableComponent.hasFilteredItems &&
      ...
      (!this.selectableComponent.hasTemplateRender ||
        !this.selectableComponent.hasTemplateRender('searchFail')) && (h("div", { class: "ion-margin ion-text-center" }, this.selectableComponent.searchFailText)), !this.selectableComponent.hasVirtualScroll && this.selectableComponent.hasFilteredItems && (h("ion-list", null, this.selectableComponent.filteredGroups.map(group => {
      return (h("ion-item-group", null, this.selectableComponent.hasGroups && (h("ion-item-divider", { color: this.selectableComponent.groupColor }, this.selectableComponent.hasTemplateRender &&
        this.selectableComponent.hasTemplateRender('group') ? (h("span", { ref: element => {
          this.selectableComponent.templateRender(element, {
            type: 'group',
          });
        } })) : (h("ion-label", null, group.text)), this.selectableComponent.hasTemplateRender &&
...
export { IonicSelectableComponent as ionic_selectable, IonicSelectableModalComponent as ionic_selectable_modal };
